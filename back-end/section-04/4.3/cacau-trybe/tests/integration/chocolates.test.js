...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/search', function () {
    it('Retorna os chocolates com o nome informado', async function () {
      ...
      expect(response.status).to.be.equal(200);
      expect(response.body).to.deep.equal(filteredChocolates);
    });

    it('Retorna um array vazio quando o chocolate com nome informado não existir', async function () {
      const response = await chai
        .request(app)
  ...
  describe('Usando o método PUT em /chocolates/:id', function () {
    ...
    it('Quando o ID não exite retorna uma mensagem de não encontrado', async function () {
