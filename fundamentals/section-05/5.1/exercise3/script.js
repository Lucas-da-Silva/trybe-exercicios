document.querySelector("body").style.backgroundColor = 'rgb(188, 185, 185)';
document.querySelector('#header-container').style.backgroundColor = 'green';

document.querySelector(".emergency-tasks").style.backgroundColor = 'rgb(254, 177, 129)';
document.querySelector(".no-emergency-tasks").style.backgroundColor = 'rgb(252, 252, 74)';
